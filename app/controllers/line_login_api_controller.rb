class LineLoginApiController < ApplicationController
    ...
    def login
        ...
        redirect_uri = CGI.escape('https://ba46-203-138-116-254.jp.ngrok.io/line_login_api/callback') #CGI.escape(line_login_api_callback_url)
        state = session[:state]
    ...
    def get_line_user_id_token(code)
        ...
        redirect_uri = 'https://ba46-203-138-116-254.jp.ngrok.io/line_login_api/callback' #line_login_api_callback_url
